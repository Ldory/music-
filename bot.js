...
client.channels.find('id', '476521082174570517').setName(`Time - ${hours} : ${ReBeeL} : ${ReBeeeL} ${suffix}`) 
client.channels.find('id', '476521158171295745').setName(`Date : ${Codes} - ${CodeS} - ${CoDeS}`)
}, 1000);
});
